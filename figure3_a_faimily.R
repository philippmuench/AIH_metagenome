...
write.table(fit.top, file="results/figure3/figure3_family_aih_vs_helathy_new.tsv", sep="\t", quote=F)
...
fit.top <- topTable(fit2, number=Inf, adjust.method="fdr")
fit.top$star <- add.significance.stars(fit.top$adj.P.Val)
write.table(fit.top, file="results/figure3/figure3_family_aih_vs_control_new.tsv", sep="\t", quote=F)
...
fit.top <- topTable(fit2, number=Inf, adjust.method="fdr")
fit.top$star <- add.significance.stars(fit.top$adj.P.Val)
write.table(fit.top, file="results/figure3/figure3_family_healthy_vs_control_new.tsv", sep="\t", quote=F)
